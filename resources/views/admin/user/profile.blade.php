                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="password">Password <small class="text-info">(Enter
                                                            password
                                                            If you want to change)</small></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label"
                                                            for="image">{{ $user->image?$user->image:'Choose image' }}</label>
                                                    </div>
                                                    @error('avatar')
                                                    <div class="alert alert-danger mt-2 mb-2">{{ $message }}</div>
                                                    @enderror
                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img class="img-fluid rounded-circle"
                                            src="{{ asset('back_temp/dist/'.$user->image) }}" alt="">
                                        <div class="mt-2">
                                            <h5>{{ $user->name }}</h5>
                                            <p>{{ $user->email }}</p>
                                        </div>
